...
$PHPTHUMB_CONFIG['document_root'] = '/var/www/vhosts/oasidoriente.eu/';
...
if ( (new phpthumb_functions)->version_compare_replacement(phpversion(), '4.3.2', '>=') && !defined('memory_get_usage') && !@ini_get('memory_limit')) {
...
$PHPTHUMB_CONFIG['error_image_width']           = 95;      // default width for error images
$PHPTHUMB_CONFIG['error_image_height']          = 95;      // default height for error images
$PHPTHUMB_CONFIG['error_message_image_default'] = '/img/nofoto.gif';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
