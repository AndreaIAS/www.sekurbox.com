...
if ($todo=='view') {  ?>
  ...
  <div class="centercontent tables">
        ...
        <div id="contentwrapper" class="contentwrapper">
               ...
               <a href="<?=BASE_URL;?>marche.php?opt=new">
            ...
            <?php }else{ foreach ($records as $list) {    ?> 
                 ...
                 <tr class="gradeX">
                        ...
                        <td>
                          ...
                          <a href="../upload/marche/<?=$list['immagine'];?>" data-lightbox="<?=$list['nome_it'];?>" >     
                             <img src="../upload/marche/<?=$list['immagine'];?>" style='width:100px;'/>  
                          </a>    
                          <?php  } ?>  
                        </td>
                        <td class="center"><a href="javascript:void(null);" onclick="jQuery('#edit<?=$list['id'];?>').submit();">Modifica</a> &nbsp; 
                        <a href="" class="delete" for="<?=BASE_URL;?>§<?=$list['id'];?>§elimina§bag_marche">Elimina</a>
   ...
   <?php   }   //FINE VISUALIZZAZIONE  
    ...
    <div class="centercontent">
        ...
        <div id="formbasic" class="subcontent">
                     ...
                     <form id="form_bag_marche" class="stdform" action="javascript:void(null)" method="post">
                      <input name="function" id="function" value="insmarca" type="hidden" />
                       <div class="contenttitle2"><h3>NUOVA MARCA</h3></div><!--contenttitle--><br />
...
<?php }  //FINE INSERIMENTO PRODOTTO
...
else if($todo=='edit') { //INIZIO MODIFICA MARCA

     $db->query("SELECT * FROM bag_marche WHERE id='".$_REQUEST['id']."' ");
     $list = $db->single();
    ...
    <div class="centercontent">   
        ...
        <div id="formbasic" class="subcontent">
                       ...
                       <input name="function" id="function" value="editmarca" type="hidden" />
                       <input name="id" value="<?=$_REQUEST['id'];?>" type="hidden" />
                       <div class="contenttitle2"><h3>MODIFICA MARCA</h3></div><!--contenttitle--><br />
		        ...
		        <b>Immagine Marca</b><br />        
                         <?php  if($list['immagine']!=''){ ?>
                        <a href="../upload/marche/<?=$list['immagine'];?>" data-lightbox="immagini" >
                            <img src="../upload/marche/<?=$list['immagine'];?>" style='width:100px;'/>  
                          </a>
                         <?php } ?>
                        <input  id="img_file" accept="*" name="img_file"  type="file"   >
...
<script type="text/javascript" src="<?=BASE_URL;?>funzionijs/marche.js"></script>
