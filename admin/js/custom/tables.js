...
jQuery(document).ready(function(){
	...
	jQuery('.stdtable a.delete').click(function(){
		var c = confirm('Sei sicuro di voler eliminare questo record?');
        if(c){
              var path=jQuery(this).attr('for').split('§');
              jQuery.post(path[0]+'functionload.php',{function:path[2],idrecord:path[1],table:path[3]});
