...
<!--                      <th class="head1">Macrocategoria</th> -->
                          ...
                          <th class="head0" style="width:20px;" >Icona</th>
                          <th class="head1" >&nbsp;</th>      
                        </tr>
...
<!--                         <td>
                        ...
                        <td>
                          ...
                          <a href="../upload/cate/<?=$list['immagine'];?>" data-lightbox="<?=$list['nome_it'];?>" >     
                             <img src="../upload/cate/<?=$list['immagine'];?>" style='width:100px;'/>  
                          </a>    
                          <?php  } ?>  
                        </td>
                        <td style="font-size:20px;"><center><i class="fa  fa-<?=$list['font_awesome_code'];?>"></i></center> </td>
...
<!--                        <p>
		            ...
		            <b>Posizione</b><br />
                        ...
                        <p>
		            <b>Codice icona categoria</b><br />
                            <input type="text" name="font_awesome_code" id="font_awesome_code" class="smallinput" />
                       </p>
                       
                     
                    <p style="width:40%">
                        <b>Immagine Categoria</b><br />    
...
<!--                        <p>
		            ...
		            <b>Posizione</b><br />
                         ...
                         <p>
		            <b>Codice icona categoria</b><br />
                            <input type="text" name="font_awesome_code" id="font_awesome_code" class="smallinput" value="<?=$list['font_awesome_code'];?>" />
                       </p>
                       
                       <p style="width:40%">
		        <b>Immagine Categoria</b><br />        
                         <?php  if($list['immagine']!=''){ ?>
                        <a href="../upload/cate/<?=$list['immagine'];?>" data-lightbox="immagini" >
                            <img src="../upload/cate/<?=$list['immagine'];?>" style='width:100px;'/>  
                          </a>
                         <?php } ?>
                        <input  id="img_file" accept="*" name="img_file"  type="file"   >
...
<script type="text/javascript" src="<?=BASE_URL;?>funzionijs/categorie.js"></script>
