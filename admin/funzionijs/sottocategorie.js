    jQuery(document).ready(function(){ 
       // jQuery('input:checkbox, input:radio, select.uniformselect, input:file').uniform();
        ...
        jQuery('body').on("blur",".invia",function() {
            ...
            jQuery.post("functionload.php", {table:'bag_scat',id:idattuale,valore:jQuery(this).val(),function:jQuery(this).attr("for")}, "json"  );
        ...
        jQuery("#form_bag_scat").submit(  
        
                function () { 
                         jQuery.post("functionload.php",jQuery("#form_bag_scat").serialize(),
                              function(data) {  
                                            ...
                                            jQuery('#err_mess').html('<div style="color:red;">'+data.errore+'</div>').fadeIn(1000);    
                                             ...
                                             setTimeout(function(){window.location.href = "sottocategorie.php";},400); 
...
jQuery("#img_file").fileinput({
        uploadUrl: './funzioni/uploadimg.php?folder=scate', // you must set a valid URL here else you will get an error
