    jQuery(document).ready(function(){ 
       // jQuery('input:checkbox, input:radio, select.uniformselect, input:file').uniform();
        ...
        jQuery('body').on("blur",".invia",function() {
            ...
            jQuery.post("functionload.php", {table:'bag_macro',id:idattuale,valore:jQuery(this).val(),function:jQuery(this).attr("for")}, "json"  );
        ...
        jQuery("#form_bag_macro").submit(  
        
                function () { 
                         jQuery.post("functionload.php",jQuery("#form_bag_macro").serialize(),
                              function(data) {  
                                            ...
                                            jQuery('#err_mess').html('<div style="color:red;">'+data.errore+'</div>').fadeIn(1000);    
                                             ...
                                             setTimeout(function(){window.location.href = "index.php";},400); 
...
jQuery("#img_file").fileinput({
        uploadUrl: './funzioni/uploadimg.php?folder=macro', // you must set a valid URL here else you will get an error
...
//                    buttons: {
//                        "SI": function() {
//                        jQuery.post("funzioni/strutture.php", {id_file: idfile, function: 'elimina_img_file'}, function (data) {
