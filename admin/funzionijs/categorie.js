    jQuery(document).ready(function(){ 
       // jQuery('input:checkbox, input:radio, select.uniformselect, input:file').uniform();
        ...
        jQuery('body').on("blur",".invia",function() {
            ...
            jQuery.post("functionload.php", {table:'bag_categorie',id:idattuale,valore:jQuery(this).val(),function:jQuery(this).attr("for")}, "json"  );
        ...
        jQuery("#form_bag_categorie").submit(  
                ...
                function () { 
                         jQuery.post("functionload.php",jQuery("#form_bag_categorie").serialize(),
                              function(data) {  
...
jQuery("#img_file").fileinput({
        uploadUrl: './funzioni/uploadimg.php?folder=cate', // you must set a valid URL here else you will get an error
