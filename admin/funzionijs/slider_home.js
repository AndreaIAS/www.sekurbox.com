...
jQuery(".img_file").fileinput({
        uploadUrl: './funzioni/uploadimg.php?folder=slider', // you must set a valid URL here else you will get an error
...
//    ],
          ...
          // console.log(data);
            var id_image=jQuery(this).attr('for');
            jQuery('<input />').attr('type', 'hidden')
                               .attr('name', "img"+id_image)
