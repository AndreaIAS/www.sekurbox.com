            ...
            <?php }else{ foreach ($records as $list) {    ?> 
                 ...
                 <tr class="gradeX">
                        ...
                        <td>
                          ...
                          <a href="../upload/macro/<?=$list['immagine'];?>" data-lightbox="<?=$list['nome_it'];?>" >     
                             <img src="../upload/macro/<?=$list['immagine'];?>" style='width:100px;'/>  
                          </a>    
                          <?php  } ?>  
                        </td>
                        <td class="center"><a href="javascript:void(null);" onclick="jQuery('#edit<?=$list['id'];?>').submit();">Modifica</a> &nbsp; 
                        <a href="" class="delete" for="<?=BASE_URL;?>§<?=$list['id'];?>§elimina§bag_macro">Elimina</a>
   ...
   <?php   }   //FINE VISUALIZZAZIONE  
    ...
    <div class="centercontent">
        ...
        <div id="formbasic" class="subcontent">
                     ...
                     <form id="form_bag_macro" class="stdform" action="javascript:void(null)" method="post">
                      <input name="function" id="function" value="insmacro" type="hidden" />
                       <div class="contenttitle2"><h3>NUOVA MACRO</h3></div><!--contenttitle--><br />
                       <p>
                    ...
                    <p style="width:40%">
                        <b>Immagine Macrocategoria</b><br />    
...
<?php }  //FINE INSERIMENTO PRODOTTO
     ...
     $db->query("SELECT * FROM bag_macro WHERE id='".$_REQUEST['id']."' ");
     $list = $db->single();
    ...
    <div class="centercontent">   
        ...
        <div id="formbasic" class="subcontent">
                       ...
                       <input name="function" id="function" value="editmacro" type="hidden" />
                       <input name="id" value="<?=$_REQUEST['id'];?>" type="hidden" />
                       <div class="contenttitle2"><h3>MODIFICA MACRO</h3></div><!--contenttitle--><br />
                        <p>
		            <b>Nome Italiano</b><br />
		        ...
		        <b>Immagine Macrocategoria</b><br />        
                         <?php  if($list['immagine']!=''){ ?>
                        <a href="../upload/macro/<?=$list['immagine'];?>" data-lightbox="immagini" >
                            <img src="../upload/macro/<?=$list['immagine'];?>" style='width:100px;'/>  
                          </a>
                         <?php } ?>
                        <input  id="img_file" accept="*" name="img_file"  type="file"   >
...
<script type="text/javascript" src="<?=BASE_URL;?>funzionijs/index_int.js"></script>
