...
class CartClass {
    ...
    { // gets cart contents
        ...
        foreach($this->items as $tmp_item)
        {
            ...
            $item['id'] = $tmp_item;
            $item['iddb'] = $this->itemdb[$tmp_item];
    ...
    function add_omaggio_item($itemid,$qty=1,$price = FALSE, $info = FALSE)
    ...
    function add_item($itemid,$itemdb,$qty=1,$price = FALSE, $info = FALSE)
    { // adds an item to cart
    ...
    { // removes an item from cart
      ...
      function edit_coltal($itemid,$col,$tal,$cod,$img)
    { // changes an items quantity

    $this->iteminfo[$itemid]['colore']=$col;
    $this->iteminfo[$itemid]['misura']=$tal;
    $this->iteminfo[$itemid]['codice']=$cod;
    $this->iteminfo[$itemid]['image']=$img;
