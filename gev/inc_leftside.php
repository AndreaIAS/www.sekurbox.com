								...
								<li>
									<div class="check-box">
                                                                        ...
                                                                        <label for="cat-1" style="padding-left:5px;">
                                                                            <a style="text-decoration:none;color:black;
                                                                               <?php if(isset($macrocategoria)  AND $macrocategoria==$list['id']){ echo ' font-weight:bolder; '; } else { } ?>" href="javascript:void(null)" onclick="$('#m<?=$list['id'];?>').slideToggle();"><?=$list['nome'];?><span>(<?=$numarticolimacro;?>)</span></a>
                                                                        </label>
									</div>
                                                                ...
                                                                <?php if(isset($macrocategoria) AND $macrocategoria==$list['id']){  } else { echo ' style="display:none" ';} ?>
                                                                    for="categorie" >
									...
									<div class="check-box">
                                                                        ...
                                                                        <label for="cat-1" style="padding-left:10px;font-size:14px;">
                                                                            <a style="text-decoration:none;
                                                                                <?php if(isset($categoria)  AND $categoria==$listc['id']){ echo ' font-weight:bolder; '; } else { } ?> " href="javascript:void(null)" onclick="$('#c<?=$listc['id'];?>').slideToggle();"><?=$listc['nome'];?><span>(<?=$numarticolicate;?>)</span></a>
                                                                        </label>
									</div>

								</li>
                                                                <ul id="c<?=$listc['id'];?>" class="nav-cat "
                                                              <?php if(isset($categoria)  AND $categoria==$listc['id']){  } else { echo ' style="display:none" ';} ?>
                                                                    for="sottocategorie">
									...
									<div class="check-box">
                                                                        ...
                                                                        <label for="cat-1" style="padding-left:20px;font-size:12px;">
                                                                            ...
                                                                            <i> <a  <?php if(isset($sottocategoria)  AND $sottocategoria==$listsc['id']){echo ' style="font-weight:bolder;" ';  } else { } ?>
