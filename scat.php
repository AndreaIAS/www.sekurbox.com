...
$scat=$_REQUEST['id_scat'];
    
$title_it=$title_en=ucfirst(strtolower($list['nome_'.$lng]))." | Sekurbox.com";
$description_it="Acquista su Sekurbox ".ucfirst(strtolower($list['nome_'.$lng])).". Scopri i prezzi e le offerte di ".ucfirst(strtolower($list['nome_'.$lng]));
$description_en="Buy on Sekurbox ".ucfirst(strtolower($list['nome_'.$lng])).". Discover the prices and offers of ".ucfirst(strtolower($list['nome_'.$lng]));
...
<!--                                        <button class="btn sorting-btn dropdown-toggle" data-path="default" type="button" data-toggle="dropdown">Default Sorting<span class="caret"></span>
                              ...
                              <div 
                                 ...
                                 <ul>
                                    ...
                                    <li><span data-path=".<?=$listm['id'];?>"><?=$listm['nome_'.$lng];?></span></li>
                                     <?php } ?>
                                 </ul>
                              </div>
                              </div>     
                               ...
                               <div style="clear:both"></div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">  
                                    <div><?=$lang['cerca_nel_nome'];?></div> 
                                    <i class="fa fa-search  jplist-icon"></i>
                                    <input type="text" data-path=".title" value="" class="jplist-no-right-border"   data-control-type="textbox" data-control-name="title-filter" data-control-action="filter" >
                        ...
                        <div class="row inner-section-space-top include-item">
                            ...
                            $db->query("SELECT bag_prodotti.*,
                                        ...
                                        WHERE bag_prodotti.id_sottocategoria=bag_scat.id
                                        AND bag_prodotti.id_marca=bag_marche.id
                                        AND bag_scat.id='".$_REQUEST['id_scat']."'
                                        ORDER by posizione
                                       ");
                            $recordleft = $db->resultset();
                            foreach ($recordleft as $list) { 
                                            ...
                                            <div class="media" style="border: solid 1px #dedede;">
                                                ...
                                                <div class="media-body" style="line-height:20px;">
                                                 ...
                                                 <?php echo $text_prezzo; ?>    
                                                    ...
                                                    <div style="clear:both"></div>     
                                                    <br />
                                                    <?=ucfirst(strtolower(trim($list['descrizione_'.$lng])));?>
                                                    </div>
                                                    <div class="product-details-content">
                                                        ...
                                                        <p style="margin-bottom:5px;"> 
                                                         ...
                                                         <p style="margin-bottom:5px;"><span style="display:inline"><b><?=$lang['categoria'];?>:</b></span> <?=ucfirst(strtolower($list['nome_scat']));?></p>
                                                    </div>
