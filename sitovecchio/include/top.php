<div id="top_sn">
    <div id="box_lingua">		
        <?php 
            ...
            $nome_pagina = substr($nome_pagina, 2); 
            $array_lin = explode("/",$nome_pagina);
            $nar = count($array_lin);
            foreach ($flags as $k=>$v)
            {
            if ($v != $lingua)
            {
            $nome_pagina_corrente = basename($_SERVER['PHP_SELF']);
                if ($nome_pagina_corrente == "prodotti-dettaglio.php")
                {
                    $url = "http://".$nome_host . "/" . $v ."/". $_GET['id_prodotto'] . "/" . $array_lin[($nar-1)];
                }
                else
                {
                if ($nome_pagina_corrente == "dettaglio-articolo.php")
                {
                $url = "http://".$nome_host . "/" . $v ."/". $_GET['id_articolo'] . "/" . $array_lin[($nar-1)];	
                }
            else
            {
            $url = "http://".$nome_host . "/" . $v ."/". $array_lin[($nar-1)];	
            }
                }
            ?>
        ...
        <div class="lingua">
            <div class="bandiera">        
            <a href="<?php echo $url; ?>"><img src="http://www.sekurbox.com/images/<?php echo $flags[$k]; ?>.png" /></a>
            </div>
            <div class="lingua_voce"><a href="<?php echo $url; ?>"><?php echo $lingue[$k]; ?></a></div>
        </div>
            <?php
            }
            }
    ...
    <?php
        if (isset($_SESSION['logged']) && $_SESSION['logged'] == 1) {
            echo "<div class='top_ds_img'><img src='http://www.sekurbox.com/images/user.png' /></div><div class='top_ds_link'>" . $benvenuto ." &nbsp;". $_SESSION['email'] . "</div>
            <div class='top_ds_img'><img src='http://www.sekurbox.com/images/login.png' /></div><div class='top_ds_link'><a href='http://www.sekurbox.com/" . $lingua . "/area-riservata.html'>" . $area_riservata . "</a></div>
            <div class='top_ds_img'><img src='http://www.sekurbox.com/images/logout.png' /></div><div class='top_ds_link'><a href='http://www.sekurbox.com/" . $lingua . "/logout.html'>Logout</a></div>";
        }
        else 
        {
    ?> 
    <div class="top_ds_img"> 
        <img src="http://www.sekurbox.com/images/user.png" />
    </div>
    <div class="top_ds_link"> 
        <a href="http://www.sekurbox.com/<?php echo $lingua; ?>/registrati.html"><?php echo $registrati;?></a>
    </div>
    <div class="top_ds_img"> 
        <img src="http://www.sekurbox.com/images/login.png" />
    </div>
    <div class="top_ds_link"> 
        <a href="http://www.sekurbox.com/<?php echo $lingua; ?>/login.html">Login</a>
    </div>
    <div class="top_ds_img"> 
        <img src="http://www.sekurbox.com/images/newsletter.png" />
    </div>
    <div class="top_ds_link"> 
        <a href="http://www.sekurbox.com/<?php echo $lingua; ?>/iscriviti-alla-newsletter.html"><?php echo $iscriviti_newsletter;?></a>
    </div>
    <?php } ?>
    <!--
    <div class="top_ds_img"> 
        <img src="http://www.sekurbox.com/images/blog.png" />
    </div>
    <div class="top_ds_link"> 
        <a href="http://www.sekurbox.com/<?php echo $lingua; ?>/blog.html">Blog</a>
    </div>
   -->
</div>
<?php
...
if ($url =="http://www.sekurbox.com/" . $lingua . "/cassa-step-1.html"
or
$url =="http://www.sekurbox.com/" . $lingua . "/carrello.html"
or
$url =="http://www.sekurbox.com/" . $lingua . "/cassa-step-2.html"
or
$url =="http://www.sekurbox.com/" . $lingua . "/cassa-step-2b.html"
or
$url =="http://www.sekurbox.com/" . $lingua . "/cassa-step-3.html"
or
$url =="http://www.sekurbox.com/" . $lingua . "/cassa-step-4.html")
{
echo '<div id="continua_top"><a href="http://www.sekurbox.com/' . $lingua . '/prodotti.html">' . $continua_shopping . '</a></div>';
}
else
{
?>	
<div id="top_ds">
    <div id="testo_cart">
		<?php 
			...
			{
				echo $il_tuo_carrello_vuoto;
			}
			else
			{
				echo $il_tuo_carrello;
			}
		?>
    </div>
    <div id="cart">
        <div class="numero_cart"><?php echo $numero_articoli;?></div>
        <div id="cart_open">
  ...
  // echo  $id_prodotto." - ".$prezzo_scontato." - ".$riga_carrello_sopra['quantita'];
   ...
   $totale_carrello_sopra=$totale_carrello_sopra+($prezzo_scontato * $riga_carrello_sopra['quantita']);
            ...
            <div id="total_cart_action">
                <div id="total_cart_action_sn"><div id="continua_lo_shopping"><a href="http://www.sekurbox.com/<?php echo $lingua;?>/prodotti.html"><?php echo $continua_shopping;?></a></div></div>
                <div id="total_cart_action_ds">
