...
<div class="widget">
                    <div class="head">
                        ...
                        <h2>Inserisci una nuova sezione prodotti</h2>
                    </div>                                               
                    <form id="validate" method="POST" onsubmit="javascript:notify('Validation','Form #validate submited');" action="insert/inseriscinuovasezione.php">
                    <div class="block-fluid">

						<div class="row-form">
                            <div class="span2">Nome Italiano:</div>
                            <div class="span10">
                                <input type="text" class="validate[required]" name="nome_sezione_ita"/>
