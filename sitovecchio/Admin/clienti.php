...
<body>   
                        ...
                        <table class="aTable" cellpadding="0" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th width="10%">Tipo</th>
                                    <th width="16%">Nome</th>
                                    <th width="16%">Azienda</th>
                                    <th width="10%">Email</th>
                                    <th width="7%">Codice Sconto</th>
                                    <th width="7%">Codice per installatore</th>
                                    <th width="7%">Codice per privato</th>
                                    <th width="5%">Approvato</th>
                                    <th width="5%">Sconto %</th>
    ...
    <!-- Bootrstrap modal -->
                                        <div id="bModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-header">
                                                ...
                                                <h3 id="myModalLabel">Elimina questa questo cliente</h3>
                                            </div>
                                            <div class="modal-body">
                                                <p>Vuoi eliminare definitivamente questo cliente?</p>
                                            </div>
                                            <div class="modal-footer">
                                                <button class="btn btn-warning delete" id="" data-dismiss="modal" aria-hidden="true">Si la voglio eliminare</button> 
                                                <button class="btn" data-dismiss="modal" aria-hidden="true">No</button>            
                                            </div>
                                        </div>       
  <script>
  
  $(".deletemodal").live("click", function(){
	  var id = $(this).attr("id");
	  $(".delete").attr("id",id);
  ...
  $(".delete").click(function(){
	  var id = $(this).attr("id");
	  location.href = "delete/cancella_cliente.php?id="+id;
	  });
  </script>   
</body>
</html>
