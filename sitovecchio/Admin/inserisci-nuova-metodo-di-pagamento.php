...
<div class="widget">
                    <div class="head">
                        ...
                        <h2>Inserisci un nuovo metodo di pagamento</h2>
                    </div>                                               
                    <form id="validate" method="POST" onsubmit="javascript:notify('Validation','Form #validate submited');" action="insert/inseriscinuovometododipagamento.php">
                    <div class="block-fluid">

						<div class="row-form">
                            <div class="span2">Metodo di pagamento:</div>
                            <div class="span10">
                                <input type="text" class="validate[required]" name="nome_pagamento_ita"/>
                		...
                		<div class="widget">
                    		...
                    		<div class="block-fluid editor">  
                        		<textarea name="testo_pagamento_ita" style="height: 300px;"></textarea>
                        		<script>
                        ...
                        <div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate[required]" name="costo_metodo_di_pagamento"/>
                                <span class="bottom">Il campo non pu&ograve; essere vuoto</span>
                            </div>
                        </div>                         
