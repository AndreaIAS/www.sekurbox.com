...
<div class="widget">
                    <div class="head">
                        ...
                        <h2>Inserisci una nuova immagine all'articolo</h2>
                    </div>                                               
                    <form id="validate" method="POST" onsubmit="javascript:notify('Validation','Form #validate submited');" enctype="multipart/form-data" action="crop-miniatura-articolo.php?id_articolo=<?php echo $id_articolo; ?>">
