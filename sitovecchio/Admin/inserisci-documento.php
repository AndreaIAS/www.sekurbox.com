...
$id_technical_marss = $_GET["id_technical_marss"];
?>
<!DOCTYPE html>
<html lang="en">
<head>        
...
<div class="widget">
                    ...
                    <form id="validate" method="POST" onsubmit="javascript:notify('Validation','Form #validate submited');" enctype="multipart/form-data" action="upload/upload-documento.php">
