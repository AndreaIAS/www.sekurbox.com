...
<div class="widget">
                    <div class="head">
                        ...
                        <h2>Inserisci una nuova spesa di spedizione</h2>
                    </div>                                               
                    <form id="validate" method="POST" onsubmit="javascript:notify('Validation','Form #validate submited');" action="insert/inseriscinuovaspesadispedizione.php">
                    <div class="block-fluid">

						<div class="row-form">
                            <div class="span2">Spesa di Spedizione:</div>
                            <div class="span10">
                                <input type="text" class="validate[required]" name="nome_spesa_di_spedizione_ita"/>
                		...
                		<div class="widget">
                    		...
                    		<div class="block-fluid editor">  
                        		<textarea name="desc_spesa_di_spedizione_ita" style="height: 300px;"></textarea>
                        		<script>
                        ...
                        <div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate[required]" name="costo_spesa_spedizione"/>
                                <span class="bottom">Il campo non pu&ograve; essere vuoto</span>
                            </div>
                        </div>                         
