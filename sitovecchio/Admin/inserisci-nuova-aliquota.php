...
<div class="widget">
                    ...
                    <form id="validate" method="POST" onsubmit="javascript:notify('Validation','Form #validate submited');" action="insert/inseriscinuovaaliquotaiva.php">
                    <div class="block-fluid">

						<div class="row-form">
                            <div class="span2">IVA:</div>
                            <div class="span10">
                                <input type="text" class="validate[required]" name="iva"/>
