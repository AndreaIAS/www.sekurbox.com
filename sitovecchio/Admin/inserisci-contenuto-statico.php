...
<div class="widget">
                    <div class="head">
                        ...
                        <h2>Inserisci contenuto statico</h2>
                    </div>                                                                          
                    <form id="validate" method="POST" action ="insert/inseriscicontenutostatico.php" onsubmit="javascript:notify('Validation','Form #validate submited');">
                    ...
                    <div class="row-form">
                		...
                		<div class="widget">
                    		...
                    		<div class="block-fluid editor">  
                        		<textarea name="contenuto_statico_ita" style="height: 300px;"></textarea>
                        		<script>
