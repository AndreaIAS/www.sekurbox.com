...
<?php
		...
		$Risultato=mysql_query("SELECT * FROM modelli ORDER BY codice_modello ASC", $db);
...
?>                 
    ...
    <div class="content">            
      ...
      <div class="row-fluid">
        ...
        <div class="widget">
                <div class="head">
                    <h2><?php echo $tot_records;?> aliquote presenti nel database</h2>                       
                </div>                
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">                        
                            <thead>
                                <tr>
                                    ...
                                    <th width="60%">Modello</th>
                                    <th width="10%">Posizione</th>
                                    <th width="5%">Modellino</th>
                                    <th width="5%">Modello</th>
							...
							?>
                                <tr>
                                    <td><?php echo $riga['codice_modello'];?></td>
                                    <td><?php echo $riga['nome_modello'];?></td>
								<td>
									<?php echo $riga['posizione'];?>
                                        <div id="inserisci_risultato"><a href="#" onclick="visualizza('<?php echo $riga['id_modello']; ?>'); return false">Mod. Posizione</a></div>
                                            <div id="<?php echo $riga['id_modello']; ?>" style="display:none">
                                                <form id="form" name="form" method="post" action="update/modifica_posizione_modello.php?id_modello=<?php echo $riga['id_modello']; ?>">
                                    ...
                                    <td class="TAC">
                                    <?php echo "<a href='immagine-modellino.php?id_modello=" . $riga['id_modello']. "'><span class='icon-camera'></span></a>"; ?> 
                                    </td>                                    
                                    <td class="TAC">
                                    <?php echo "<a href='immagine-modello.php?id_modello=" . $riga['id_modello']. "'><span class='icon-camera'></span></a>"; ?> 
                                    </td>                                    
                                    <td class="TAC">
                                     	<?php echo "<a href='update/modifica_modello.php?id_modello=" . $riga['id_modello']. "'><span class='icon-pencil'></span></a>"; ?> 
                                    </td>
                                    <td class="TAC">
                                        <a href="#bModal" role="button" class="btn deletemodal" id="<?php echo $riga['id_modello'];?>" data-toggle="modal"><span class="icon-trash"></span></a>
                                        <!-- Bootrstrap modal -->
                                        <div id="bModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-header">
                                                ...
                                                <h3 id="myModalLabel">Elimina questo modello</h3>
                                            </div>
                                            <div class="modal-body">
                                                <p>Vuoi eliminare definitivamente questo modello?</p>
                                            </div>
...
<script type="text/javascript" language="javascript">
  ...
  $(".delete").click(function(){
	  var id = $(this).attr("id");
	  location.href = "delete/cancella_modello.php?id="+id;
	  });
  </script>    
</body>
</html>
