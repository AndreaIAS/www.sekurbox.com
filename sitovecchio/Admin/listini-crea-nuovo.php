...
<div class="widget">
                    <div class="head">
                        ...
                        <h2>Inserisci un nuovo listino prezzi</h2>
                    </div>                                               
                    <form id="validate" method="POST" onsubmit="javascript:notify('Validation','Form #validate submited');" action="insert/inseriscinuovolistino.php">
                    <div class="block-fluid">

						<div class="row-form">
                            <div class="span2">Nome listino:</div>
                            <div class="span4">
                                <input type="text" class="validate[required]" name="listino"/>
                                <span class="bottom">Il campo non pu&ograve; essere vuoto</span>
                            </div>
                            <div class="span2">Sconto listino:</div>
                            <div class="span4">
                                <input type="text" class="validate[required]" name="sconto_listino"/>
                                <span class="bottom">Il campo non pu&ograve; essere vuoto</span>
                            </div>                        
                        </div>                  
