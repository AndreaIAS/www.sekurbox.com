...
<?php
		...
		$Risultato=mysql_query("SELECT * FROM sezioni_prodotti ORDER BY id_sezione DESC", $db);
...
?>                 
    ...
    <div class="content">            
      ...
      <div class="row-fluid">
        ...
        <div class="widget">
                <div class="head">
                    <h2><?php echo $tot_records;?> sezioni presenti nel database</h2>                       
                </div>                
                    <div class="block-fluid">
                        <table class="fpTable" cellpadding="0" cellspacing="0" width="100%">                        
                            <thead>
                                <tr>
                                    <th width="5%">ID</th>
                                    <th width="50%">Nome Italiano</th>
                                    <th width="15%">Posizione</th>
                                    <th width="10%" class="TAC">Modifica</th>
                                    <th width="10%">Puglia</th>
                                    <th width="10%" class="TAC">Elimina</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php
							...
							?>
                                <tr>
                                    <td><?php echo $riga['id_sezione'];?></td>
                                    <td><?php echo $riga['nome_sezione_ita'];?></td>
                                    <td>
									<?php echo $riga['posizione'];?>
                                        <div id="inserisci_risultato"><a href="#" onclick="visualizza('<?php echo $riga['id_sezione']; ?>'); return false">Mod. posizione</a></div>
                                            <div id="<?php echo $riga['id_sezione']; ?>" style="display:none">
                                                <form id="form" name="form" method="post" action="update/modificaposizione-sezione.php?id_sezione=<?php echo $riga['id_sezione']; ?>">
                                    ...
                                    <td class="TAC">
                                     	<?php echo "<a href='update/modifica_sezione.php?id_sezione=" . $riga['id_sezione']. "'><span class='icon-pencil'></span></a>"; ?> 
                                    </td>
                                    <td>
                                    <?php 
									if ($IdSezione <> $riga['id_sezione'])
										{
											if ($riga['puglia'] == 0)
											{
											echo "<span class='label label-important'>NO</span><br /><a href='visible/sezione_solo_puglia.php?id_sezione=" . $riga['id_sezione']. "'><span class='icon-ok'></span></a>";			  
											}
											else
											{
											echo "<span class='label label-info'>SI</span><br /><a href='visible/sezione_tutti.php?id_sezione=" . $riga['id_sezione']. "'><span class='icon-remove'></span></a>";	
											}
										}
									?> 
                                    </td>                                    
                                     <td class="TAC">
<a href="#bModal" role="button" class="btn deletemodal" id="<?php echo $riga['id_sezione'];?>" data-toggle="modal"><span class="icon-trash"></span></a>
<!-- Bootrstrap modal -->
        <div id="bModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-header">
                ...
                <h3 id="myModalLabel">Elimina questa sezione prodotto</h3>
            </div>
            <div class="modal-body">
                <p>Vuoi eliminare definitivamente questa sezione prodotto?</p>
            </div>
...
<script type="text/javascript" language="javascript">
  ...
  $(".delete").click(function(){
	  var id = $(this).attr("id");
	  location.href = "delete/cancella_sezione_prodotto.php?id="+id;
	  });
  </script>    
</body>
</html>
