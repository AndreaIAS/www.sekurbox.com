...
<?php
		...
		$Risultato=mysql_query("SELECT * FROM spese_di_spedizione ORDER BY id_spesa_di_spedizione DESC", $db);
...
?>                 
    ...
    <div class="content">            
      ...
      <div class="row-fluid">
        ...
        <div class="widget">
                <div class="head">
                    <h2><?php echo $tot_records;?> spese di spedizione presenti nel database</h2>                       
                </div>                
                    <div class="block-fluid">
                        <table class="fpTable" cellpadding="0" cellspacing="0" width="100%">                        
                            <thead>
                                <tr>
                                    <th width="80%">SPESA DI SPEDIZIONE</th>
							...
							?>
                                <tr>
                                    <td><?php echo $riga['nome_spesa_di_spedizione_ita'];?></td>
                                    <td class="TAC">
                                     	<?php echo "<a href='update/modifica_spesa_di_spedizione.php?id_spesa_di_spedizione=" . $riga['id_spesa_di_spedizione']. "'><span class='icon-pencil'></span></a>"; ?> 
                                    </td>
                                    <td class="TAC">
<a href="#bModal" role="button" class="btn deletemodal" id="<?php echo $riga['id_spesa_di_spedizione'];?>" data-toggle="modal"><span class="icon-trash"></span></a>
<!-- Bootrstrap modal -->
        <div id="bModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-header">
                ...
                <h3 id="myModalLabel">Elimina questa spesa di spedizione</h3>
            </div>
            <div class="modal-body">
                <p>Vuoi eliminare definitivamente questa spesa di spedizione?</p>
            </div>
  ...
  $(".delete").click(function(){
	  var id = $(this).attr("id");
	  location.href = "delete/cancella_spesa_di_spedizione.php?id="+id;
	  });
  </script>    
</body>
</html>
