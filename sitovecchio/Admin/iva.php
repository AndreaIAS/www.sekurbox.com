...
<?php
		...
		$Risultato=mysql_query("SELECT * FROM iva ORDER BY id_iva DESC", $db);
                ...
                <div class="head">
                    ...
                    <div class="block-fluid">
                        <table class="fpTable" cellpadding="0" cellspacing="0" width="100%">                        
							...
							?>
                                <tr>
                                    <td><?php echo $riga['iva'];?></td>
                                    <td class="TAC">
                                     	<?php echo "<a href='update/modifica_iva.php?id_iva=" . $riga['id_iva']. "'><span class='icon-pencil'></span></a>"; ?> 
                                    </td>
                                    <td class="TAC">
<a href="#bModal" role="button" class="btn deletemodal" id="<?php echo $riga['id_iva'];?>" data-toggle="modal"><span class="icon-trash"></span></a>
<!-- Bootrstrap modal -->
        <div id="bModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-header">
                ...
                <h3 id="myModalLabel">Elimina questa aliquota IVA</h3>
            </div>
            <div class="modal-body">
                <p>Vuoi eliminare definitivamente questa aliquota IVA?</p>
            </div>
...
<script type="text/javascript" language="javascript">
  ...
  $(".delete").click(function(){
	  var id = $(this).attr("id");
	  location.href = "delete/cancella_aliquota_iva.php?id="+id;
	  });
  </script>    
</body>
</html>
