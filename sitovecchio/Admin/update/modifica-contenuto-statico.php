...
if (!isset($_GET["id_contenuto_statico"]))
	...
	$Risultato=mysql_query("SELECT * FROM  contenuti_statici WHERE id_contenuto_statico = '$IdContenutoStatico'", $db);
	if (!$Risultato)
	{
...
<div class="widget">
                    <div class="head">
						...
						{
						?>
                        <h2>Modifica la pagina "<?php echo $riga['titolo_ita'];?>"</h2>
                    </div>                                                                          
                    <form id="validate" method="POST" action ="modificacontenutostatico.php?id_contenuto_statico=<?php echo $IdContenutoStatico; ?>" onsubmit="javascript:notify('Validation','Form #validate submited');">
                    ...
                    <div class="row-form">
                		...
                		<div class="widget">
                    		...
                    		<div class="block-fluid editor">  
                        		<textarea name="contenuto_statico_ita" style="height: 300px;"><?php echo $riga['contenuto_statico_ita'];?></textarea>
                        		<script>
                            		$(document).ready(function(){
                                		var contenuto_statico_ita = CKEDITOR.replace('contenuto_statico_ita');                                
                                		$("#contenuto_statico_ita").click(function(){
                                    		alert(contenuto_statico_ita.getData());
                                		});
                            		});
                        		</script>                        
                    		</div>
