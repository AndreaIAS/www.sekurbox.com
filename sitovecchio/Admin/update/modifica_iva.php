...
if (!isset($_GET["id_iva"]))
	...
	$Risultato=mysql_query("SELECT * FROM iva WHERE id_iva = '$id_iva'", $db);
	if (!$Risultato)
	{
...
<div class="widget">
                    <div class="head">
						...
						{
						?>
                        <h2>Modifica l'aliquota Iva al <?php echo $riga['iva'];?> %</h2>
                    </div>                                                                           
                    <form id="validate" method="POST" action ="modificaaliquotaiva.php?id_iva=<?php echo $id_iva; ?>" onsubmit="javascript:notify('Validation','Form #validate submited');">
                    <div class="block-fluid">

						<div class="row-form">
                            <div class="span2">Aliquota IVA:</div>
                            <div class="span10">
                                <input type="text" class="validate[required]" name="iva" value="<?php echo $riga['iva'];?>"/>
