...
if (!isset($_GET["id_admin"]))
	...
	$Risultato=mysql_query("SELECT * FROM admin WHERE id_admin = '$IdAdmin'", $db);
	if (!$Risultato)
	{
...
<div class="widget">
                    <div class="head">
						...
						{
						?>
                        <h2>Modifica i dati di questo amministratore <?php echo $riga['username'];?></h2>
                    </div>                                                                           
                    <form id="validate" method="POST" action ="modificaamministratore.php?id_admin=<?php echo $IdAdmin; ?>" onsubmit="javascript:notify('Validation','Form #validate submited');">
                    <div class="block-fluid">

						<div class="row-form">
                            <div class="span2">Username:</div>
                            <div class="span10">
                                <input type="text" class="validate[required]" name="username" value="<?php echo $riga['username'];?>"/>
						...
						<div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate[required]" name="password" value="<?php echo $riga['password'];?>"/>
                                <span class="bottom">Il campo non pu&ograve; essere vuoto</span>
                            </div>
                        </div>                                               
