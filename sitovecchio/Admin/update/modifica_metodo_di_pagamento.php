...
if (!isset($_GET["id_metodo_pagamento"]))
	{
		$id_metodo_pagamento = "";
	}
	else
	...
	$Risultato=mysql_query("SELECT * FROM metodi_di_pagamento WHERE id_metodo_pagamento = '$id_metodo_pagamento'", $db);
	if (!$Risultato)
	{
...
<div class="widget">
                    <div class="head">
						...
						{
						?>
                        <h2>Modifica metodo di pagamento <?php echo $riga['nome_pagamento_ita'];?></h2>
                    </div>                                                                           
                    <form id="validate" method="POST" action ="modificametododipagamento.php?id_metodo_pagamento=<?php echo $id_metodo_pagamento; ?>" onsubmit="javascript:notify('Validation','Form #validate submited');">
                    <div class="block-fluid">

						<div class="row-form">
                            <div class="span2">Metodo di pagamento:</div>
                            <div class="span10">
                                <input type="text" class="validate[required]" name="nome_pagamento_ita" value="<?php echo $riga['nome_pagamento_ita']; ?>" />
                		...
                		<div class="widget">
                    		...
                    		<div class="block-fluid editor">  
                        		<textarea name="testo_pagamento_ita" style="height: 300px;"><?php echo $riga['testo_pagamento_ita']; ?></textarea>
                        		<script>
                            		$(document).ready(function(){
                                		var testo_pagamento_ita = CKEDITOR.replace('testo_pagamento_ita');                                
                                		$("#testo_pagamento_ita").click(function(){
                                    		alert(testo_pagamento_ita.getData());
                                		});
                            		});
                        		</script>                        
                    		</div>
                        ...
                        <div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate[required]" name="costo_metodo_di_pagamento" value="<?php echo $riga['costo_metodo_di_pagamento']; ?>"/>
                                <span class="bottom">Il campo non pu&ograve; essere vuoto</span>
                            </div>
                        </div>                                                  
