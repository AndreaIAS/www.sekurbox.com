...
if (!isset($_GET["id_sottocategoria"]))
	...
	{
		$IdSottocategoria = $_GET["id_sottocategoria"];
	}
	
	$Risultato=mysql_query("SELECT * FROM sottocategorie_prodotti WHERE id_sottocategoria = '$IdSottocategoria'", $db);
	if (!$Risultato)
	{
...
<div class="widget">
                    <div class="head">
						...
						?>
                        <h2>Modifica la sottocategoria <?php echo $riga['sottocategoria_ita'];?></h2>
                    </div>                                                                           
                    <form id="validate" method="POST" action ="modificasottocategoria.php?id_sottocategoria=<?php echo $IdSottocategoria; ?>" onsubmit="javascript:notify('Validation','Form #validate submited');">
                    <div class="block-fluid">
									<div class="row-form">
                                           ...
                                           <select class="select" name="id_categoria" style="width: 100%;">
                                                        <?php
                                                    $Risultato=mysql_query("select * from categorie_prodotti", $db);
                                                    if ($Risultato){
                                                    ...
                                                    if ($categoria_selezionata == ($row['id_categoria']))
                                                        ...
                                                        echo "value='". $row['id_categoria'] . "'>" . $row['categoria_ita'] . "</option>n";
                                                        }
                                                                       }
                                                        ?>	
                                        </select>
						...
						<div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate[required]" name="sottocategoria_ita" value="<?php echo $riga['sottocategoria_ita'];?>"/>
						...
						<div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate[required]" name="sottocategoria_eng" value="<?php echo $riga['sottocategoria_eng'];?>"/>
                                <span class="bottom">Il campo non pu&ograve; essere vuoto</span>
                            </div>
                        </div>                        
