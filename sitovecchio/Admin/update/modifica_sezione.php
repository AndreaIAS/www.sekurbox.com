...
if (!isset($_GET["id_sezione"]))
	...
	$Risultato=mysql_query("SELECT * FROM sezioni_prodotti WHERE id_sezione = '$IdSezione'", $db);
	if (!$Risultato)
	{
...
<div class="widget">
                    <div class="head">
						...
						?>
                        <h2>Modifica la sezione <?php echo $riga['v'];?></h2>
                    </div>                                                                           
                    <form id="validate" method="POST" action ="modificasezione.php?id_sezione=<?php echo $IdSezione; ?>" onsubmit="javascript:notify('Validation','Form #validate submited');">
                    <div class="block-fluid">
					
						<div class="row-form">
                            <div class="span2">Nome Italiano:</div>
                            <div class="span10">
                                <input type="text" class="validate[required]" name="nome_sezione_ita" value="<?php echo $riga['nome_sezione_ita'];?>"/>
						...
						<div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate[required]" name="nome_sezione_eng" value="<?php echo $riga['nome_sezione_eng'];?>"/>
                                <span class="bottom">Il campo non pu&ograve; essere vuoto</span>
                            </div>
                        </div>  
						<div class="row-form">
