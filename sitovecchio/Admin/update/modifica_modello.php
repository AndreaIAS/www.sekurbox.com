...
if (!isset($_GET["id_modello"]))
	...
	$Risultato=mysql_query("SELECT * FROM modelli WHERE id_modello = '$id_modello'", $db);
	if (!$Risultato)
	{
...
<div class="widget">
                    <div class="head">
						...
						{
						?>
                        <h2>Modifica i dati del modello <?php echo $riga['nome_modello'];?></h2>
                    </div>                                             
                    <form id="validate" method="POST" action ="modificamodello.php?id_modello=<?php echo $id_modello; ?>" onsubmit="javascript:notify('Validation','Form #validate submited');">
                    <div class="block-fluid">

						<div class="row-form">
                            <div class="span2">Codice Modello:</div>
                            <div class="span2">
                                <input type="text" class="validate[required]" name="codice_modello" value="<?php echo $riga['codice_modello']; ?>"/>
                                <span class="bottom">Il campo non pu&ograve; essere vuoto</span>
                            </div>
                            <div class="span2">Nome Modello:</div>
                            <div class="span2">
                                <input type="text" class="validate[required]" name="nome_modello" value="<?php echo $riga['nome_modello']; ?>"/>
                                <span class="bottom">Il campo non pu&ograve; essere vuoto</span>
                            </div> 
