...
if (!isset($_GET["id_spesa_di_spedizione"]))
	{
		$id_spesa_di_spedizione = "";
	}
	else
	{
		$id_spesa_di_spedizione = $_GET["id_spesa_di_spedizione"];
	}
	
	$Risultato=mysql_query("SELECT * FROM spese_di_spedizione WHERE id_spesa_di_spedizione = '$id_spesa_di_spedizione'", $db);
	if (!$Risultato)
	{
...
<div class="widget">
                    <div class="head">
						...
						{
						?>
                        <h2>Modifica spesa di spedizione <?php echo $riga['nome_spesa_di_spedizione_ita'];?></h2>
                    </div>                                                                           
                    <form id="validate" method="POST" action ="modificaspesadispedizione.php?id_spesa_di_spedizione=<?php echo $id_spesa_di_spedizione; ?>" onsubmit="javascript:notify('Validation','Form #validate submited');">
                    <div class="block-fluid">

						<div class="row-form">
                            <div class="span2">Spesa di Spedizione:</div>
                            <div class="span10">
                                <input type="text" class="validate[required]" name="nome_spesa_di_spedizione_ita" value="<?php echo $riga['nome_spesa_di_spedizione_ita']; ?>" />
                		...
                		<div class="widget">
                    		...
                    		<div class="block-fluid editor">  
                        		<textarea name="desc_spesa_di_spedizione_ita" style="height: 300px;"><?php echo $riga['desc_spesa_di_spedizione_ita']; ?></textarea>
                        		<script>
                            		$(document).ready(function(){
                                		var desc_spesa_di_spedizione_ita = CKEDITOR.replace('desc_spesa_di_spedizione_ita');                                
                                		$("#desc_spesa_di_spedizione_ita").click(function(){
                                    		alert(desc_spesa_di_spedizione_ita.getData());
                                		});
                            		});
                        		</script>                        
                    		</div>
                        ...
                        <div class="row-form">
                            <div class="span2">Importo:</div>
                            <div class="span10">
                                <input type="text" class="validate[required]" name="costo_spesa_spedizione" value="<?php echo $riga['costo_spesa_spedizione']; ?>"/>
                                <span class="bottom">Il campo non pu&ograve; essere vuoto</span>
                            </div>
                        </div>                                                  
