...
<body>   
  ...
  <?php
		...
		$Risultato=mysql_query("SELECT ordini.*,
                                        clienti.id_cliente, clienti.nome, clienti.cognome, clienti.ragione_sociale,
                                        spese_di_spedizione.*,
                                        metodi_di_pagamento.*
                                        FROM ordini 
                                        ...
                                        ORDER BY ordini.data_ordine DESC", $db);		    
		if (!$Risultato)
		{
...
?>               
               ...
               <div class="widget">
                <div class="head">
                    ...
                    <h2>Sono presenti <?php echo $tot_records;?> ordini nel database</h2>                       
                </div>                
                        ...
                        <table class="fpTable" cellpadding="0" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="15%">Spedito con</th>
                                    <th width="15%">Pagato con</th>
                                    <th width="5%">Sconto Cliente</th>
                                    <th width="5%">Sconto Listino</th>
                                    <th width="5%">Subtotale</th>
                                    <th width="5%">Totale</th>
                                    <th width="5%" class="TAC">Pagato</th>
                                    <th width="5%" class="TAC">Spedito</th>
                                    <th width="5%" class="TAC">Dettaglio</th>
							...
							?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="dettaglio_cliente.php?id_cliente=<?php echo $riga['id_cliente'];?>">
                                        	<?php 
													echo $riga['nome'] . " " . $riga['cognome'];
													echo $riga['ragione_sociale'];
											?>
                                        </a>
                                    </td>
                                    ...
                                    <td><?php echo $riga['sconto_cliente'];?></td>
                                    <td><?php echo $riga['sconto_listino'];?></td>
                                    <td><?php echo $riga['subtotale'];?></td>
                                    <td><?php echo $riga['totale'];?></td>
                                    <td class="TAC">
                                    <?php 
									if ($IdOrdine <> $riga['id_ordine'])
										{
											if ($riga['pagato'] == 0)
											{
											echo "<span class='label label-important'>Da pagare</span><br /><a href='visible/ordine_pagato.php?id_ordine=" . $riga['id_ordine']. "'><span class='icon-ok'></span></a>";			  
											}
											else
											{
											echo "<span class='label label-info'>Pagato</span><br /><a href='visible/ordine_non_pagato.php?id_ordine=" . $riga['id_ordine']. "'><span class='icon-remove'></span></a>";	
											}
										}
									?> 
                                    </td>   
									...
									if ($IdOrdine <> $riga['id_ordine'])
										{
											if ($riga['spedito'] == 0)
											{
											echo "<span class='label label-important'>Da spedire</span><br /><a href='visible/ordine_spedito.php?id_ordine=" . $riga['id_ordine']. "'><span class='icon-ok'></span></a>";			  
											}
											else
											{
											echo "<span class='label label-info'>Pagato</span><br /><a href='visible/ordine_non_spedito.php?id_ordine=" . $riga['id_ordine']. "'><span class='icon-remove'></span></a>";	
											}
										}
									?> 
                                    </td> 
                                     <td class="TAC">
                                    <?php echo "<a href='dettaglio-ordine.php?id_ordine=" . $riga['id_ordine']. "'><span class='icon-zoom-in'></span></a>"; ?> 
                                    </td> 
                                    <td class="TAC">
                                        <a href="#bModal" role="button" class="btn deletemodal" id="<?php echo $riga['id_ordine'];?>" data-toggle="modal"><span class="icon-trash"></span></a>
                                        <!-- Bootrstrap modal -->
                                        ...
                                        <h3 id="myModalLabel">Elimina questo ordine</h3>
                                        </div>
                                        <div class="modal-body">
                                        <p>Vuoi eliminare definitivamente questo ordine?</p>
                                        </div>
  ...
  $(".delete").click(function(){
	  var id = $(this).attr("id");
	  location.href = "delete/cancella_ordine.php?id="+id;
	  });
  </script> 
</html>
