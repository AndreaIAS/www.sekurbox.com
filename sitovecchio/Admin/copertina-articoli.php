      ...
      <div class="row-fluid">
		<div class="widget">
                    <div class="head">
                        ...
                        <h2>Inserisci una nuova immagine a questo articolo</h2>
                    </div>                                               
                    <form id="validate" method="POST" onsubmit="javascript:notify('Validation','Form #validate submited');" enctype="multipart/form-data" action="salva-copertina-articoli.php?id_articolo=<?php echo $id_articolo; ?>">
