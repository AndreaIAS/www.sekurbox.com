...
<body>   
                ...
                <div class="head dark">
                    ...
                    <div class="block-fluid">
                        <table class="aTable" cellpadding="0" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th width="25%">Utente registrato</th>
                                    <th width="25%">Azienda</th>
                                    <th width="20%">Ruolo</th>
                                    <th width="10%">Nazione</th>
                                    <th width="10%">Provincia</th>
                                    <th width="5%">Anteprima</th>
    ...
    <!-- Bootrstrap modal -->
                                        <div id="bModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-header">
                                                ...
                                                <h3 id="myModalLabel">Elimina questa questo utente</h3>
                                            </div>
                                            <div class="modal-body">
                                                <p>Vuoi eliminare definitivamente questo utente?</p>
                                            </div>
  ...
  $(".delete").click(function(){
	  var id = $(this).attr("id");
	  location.href = "delete/cancella_utente.php?id="+id;
	  });
  </script>   
</body>
</html>
