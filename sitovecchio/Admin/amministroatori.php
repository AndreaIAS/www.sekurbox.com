...
<?php
		...
		$Risultato=mysql_query("SELECT * FROM admin ORDER BY id_admin DESC", $db);
...
?>                 
    ...
    <div class="content">            
      ...
      <div class="row-fluid">
        ...
        <div class="widget">
                <div class="head">
                    <h2><?php echo $tot_records;?> amministratori presenti nel database</h2>                       
                </div>                
                        ...
                        <table class="fpTable" cellpadding="0" cellspacing="0" width="100%">                        
							...
							?>
                                <tr>
                                    ...
                                    <td class="TAC">
                                     	<?php echo "<a href='update/modifica_amministratore.php?id_admin=" . $riga['id_admin']. "'><span class='icon-pencil'></span></a>"; ?> 
                                    </td>
                                    <td class="TAC">
<a href="#bModal" role="button" class="btn deletemodal" id="<?php echo $riga['id_admin'];?>" data-toggle="modal"><span class="icon-trash"></span></a>
<!-- Bootrstrap modal -->
        <div id="bModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-header">
                ...
                <h3 id="myModalLabel">Elimina questo Amministratore</h3>
            </div>
            <div class="modal-body">
                <p>Vuoi eliminare definitivamente questo amministratore?</p>
            </div>
  ...
  $(".delete").click(function(){
	  var id = $(this).attr("id");
	  location.href = "delete/cancella_amministratore.php?id="+id;
	  });
  </script>    
</body>
</html>
