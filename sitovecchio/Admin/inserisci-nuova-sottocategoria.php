...
<div class="widget">
                    <div class="head">
                        ...
                        <h2>Inserisci una nuova sottocategoria prodotti</h2>
                    </div>                                               
                    <form id="validate" method="POST" onsubmit="javascript:notify('Validation','Form #validate submited');" action="insert/inseriscinuovasottocategoria.php">
                    <div class="block-fluid">
                     <div class="row-form">
                                ...
                                <?php
                                    ...
                                    if ($Risultato){
                                        while($row = mysql_fetch_assoc($Risultato)){
                                            ...
                                            $categoria = $row['categoria_ita'];
                                            echo "<option value='" . $id_categoria . "'>" . $categoria . "</option>n";
                                                    }
                                               }
                                ?>	
                            </select>
						...
						<div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate[required]" name="sottocategoria_ita"/>
						...
						<div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate[required]" name="sottocategoria_eng"/>
                                <span class="bottom">Il campo non pu&ograve; essere vuoto</span>
                            </div>
                        </div>                        
