...
<div class="widget">
                    <div class="head">
                        ...
                        <h2>Inserisci una nuova categoria prodotti</h2>
                    </div>                                               
                    <form id="validate" method="POST" onsubmit="javascript:notify('Validation','Form #validate submited');" action="insert/inseriscinuovacategoria.php">
                    <div class="block-fluid">
                      <div class="row-form">
						...
						<?php
                            ...
                            if ($Risultato){
                                while($row = mysql_fetch_assoc($Risultato)){
                                    ...
                                    $sezione = $row['nome_sezione_ita'];
                                    echo "<option value='" . $id_sezione . "'>" . $sezione . "</option>n";
                                            }
                                       }
                        ?>	
                  </select>
						...
						<div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate[required]" name="categoria_ita"/>
						...
						<div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate[required]" name="categoria_eng"/>
                                <span class="bottom">Non deve essere vuoto</span>
                            </div>
                        </div>
						<div class="row-form">
                            ...
                            <div class="span2">
                                <input type="text" class="validate[required]" name="posizione"/>
