...
<div class="widget">
                    ...
                    <form id="validate" method="POST" action ="insert/inserisciarticolo.php" onsubmit="javascript:notify('Validation','Form #validate submited');">
                    ...
                    <div class="row-form">
                        <div class="span2">Description italiana:</div>
                        <div class="span10">
                    ...
                    <div class="row-form">
                        <div class="span2">Keywords Italiane:</div>
                        <div class="span10">
                            <input type="text" class="validate[maxSize[150]]" maxlength="150" name="keywords_ita"/>
                            <span class="bottom">Il campo non deve superare i 150 caratteri</span>
                        </div>
                    </div>
                    <div class="row-form">
                        <div class="span2">Keywords Inglesi:</div>
                        <div class="span10">
                            <input type="text" class="validate[maxSize[150]]" maxlength="150" name="keywords_eng"/>
                            <span class="bottom">Il campo non deve superare i 150 caratteri</span>
                        </div>
                    </div>                         
                    <div class="row-form">
                        ...
                        <div class="head dark">
                         ...
                         <div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate[required,custom[date]]" name="data"/>
						...
						<div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate" name="autore"/>
                        ...
                        <div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate" name="titolo_ita"/>
                                <span class="bottom">Non deve essere vuoto</span>
                            </div>
                        </div>
                        <div class="row-form">
                            ...
                            <div class="span10">
                                <input type="text" class="validate" name="titolo_eng"/>
                                <span class="bottom">Non deve essere vuoto</span>
                            </div>
                        </div>                                             
                		<div class="widget">
                    		...
                    		<div class="block-fluid editor">  
                        		<textarea name="descrizione_ita" style="height: 300px;"></textarea>
                        		<script>
                		...
                		<div class="widget">
                    		...
                    		<div class="block-fluid editor">  
                        		<textarea name="descrizione_eng" style="height: 300px;"></textarea>
                        		<script>
                            		$(document).ready(function(){
                        ...
                        <div class="row-form">
                            ...
                            <div class="span5">                            
                                <input type="radio" class="validate[required]" name="pubblicato" value="1"/> SI 
                                <input type="radio" class="validate[required]" name="pubblicato" value="0"/> NO
                                <span class="bottom">Scelta obbligatoria</span>
                            </div>
                           	<div class="span1">Home Page:</div>
                            <div class="span5">                            
                                <input type="radio" class="validate[required]" name="home_page" value="1"/> SI 
                                <input type="radio" class="validate[required]" name="home_page" value="0"/> NO
                                <span class="bottom">Scelta obbligatoria</span>
                            </div>
                        </div>
