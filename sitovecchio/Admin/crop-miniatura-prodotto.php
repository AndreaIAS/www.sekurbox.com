...
// Creo la versione 660*n dell'immagine (thumbnail) 
$numero = ($dim/$width); 
...
imagejpeg($thumb, $path, 80); // 65 è la qualità dell'immagine, da 0 a 100 
}
}
?>
<!DOCTYPE html>
...
<div class="widget">
                    <div class="head dark">
                        <div class="icon"><i class="icos-picture"></i></div>
                        <h2>Crop image</h2> 
                    </div>                    
                    <form action="salva-miniatura-prodotto.php?img=<?php echo $nome;?>" method="post" onsubmit="return checkCoords();">
