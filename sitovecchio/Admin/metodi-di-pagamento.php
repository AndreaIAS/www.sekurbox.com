...
<?php
		...
		$Risultato=mysql_query("SELECT * FROM metodi_di_pagamento ORDER BY id_metodo_pagamento DESC", $db);
...
?>                 
    ...
    <div class="content">            
      ...
      <div class="row-fluid">
        ...
        <div class="widget">
                <div class="head">
                    <h2><?php echo $tot_records;?> metodi di pagamento presenti nel database</h2>                       
                </div>                
                    <div class="block-fluid">
                        <table class="fpTable" cellpadding="0" cellspacing="0" width="100%">                        
                            <thead>
                                <tr>
                                    <th width="80%">METODO DI PAGAMENTO</th>
							...
							?>
                                <tr>
                                    <td><?php echo $riga['nome_pagamento_ita'];?></td>
                                    <td class="TAC">
                                     	<?php echo "<a href='update/modifica_metodo_di_pagamento.php?id_metodo_pagamento=" . $riga['id_metodo_pagamento']. "'><span class='icon-pencil'></span></a>"; ?> 
                                    </td>
                                    <td class="TAC">
<a href="#bModal" role="button" class="btn deletemodal" id="<?php echo $riga['id_metodo_pagamento'];?>" data-toggle="modal"><span class="icon-trash"></span></a>
<!-- Bootrstrap modal -->
        <div id="bModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-header">
                ...
                <h3 id="myModalLabel">Elimina questo metodo di pagamento</h3>
            </div>
            <div class="modal-body">
                <p>Vuoi eliminare definitivamente questo metodo di pagamento?</p>
            </div>
  ...
  $(".delete").click(function(){
	  var id = $(this).attr("id");
	  location.href = "delete/cancella_metodo_di_pagamento.php?id="+id;
	  });
  </script>    
</body>
</html>
