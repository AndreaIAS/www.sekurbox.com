...
if (!isset($_GET["id_documento_generale"]))
	{
		$id_documento_generale = "";
	}
	else
	{
		$id_documento_generale  = $_GET["id_documento_generale"];
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>   
    ...
    <?php $page="area_tecnica"; include 'include/menu.php';?> 
    ...
    <div class="content">            
      ...
      <div class="row-fluid">
  <?php				
		$Risultato=mysql_query("SELECT * FROM documenti_generali", $db);
...
?>               
        <div class="widget">
                <div class="head">
                    <h2>Sono presenti <?php echo $tot_records;?> documenti generali nel database</h2>  
                </div>                
                    <div class="block-fluid">
						<table class="fpTable" cellpadding="0" cellspacing="0" width="100%">
							...
							?>
                                <tr>
                                    <td><a href="../pdf/technicalmarss/<?php echo $riga['documento_generale_nome']; ?>" target="_blank"><?php echo $riga['documento_generale_nome']; ?></a></td>
                                   	<td>http://www.marss.eu/pdf/documentivari/<?php echo $riga['url']; ?></td>                         
                                 
                                    <td class="TAC">
                                        <a href="#bModal" role="button" class="btn deletemodal" id="<?php echo $riga['id_documento_generale'];?>" data-toggle="modal"><span class="icon-trash"></span></a>
                                        <!-- Bootrstrap modal -->
                                        <div id="bModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-header">
                                                ...
                                                <h3 id="myModalLabel">Elimina questo documento</h3>
                                            </div>
                                            <div class="modal-body">
                                                <p>Vuoi eliminare definitivamente questo documento?</p>
                                            </div>
  ...
  $(".delete").click(function(){
	  var id = $(this).attr("id");
	  location.href = "delete/cancella_documento_generale.php?id="+id;
	  });
  </script>   
</body>
</html>
