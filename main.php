...
(function($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({ siteLogo: "<a href='http://www.ac-websoft.it/sekurbox/' class='logo-mobile-menu'><img src='img/logo1.png' /></a>" });
    ...
    //Aggiunge prodotto a carello nella home, e poi mostra il messaggio sotto al prodotto modal view index
     ...
     $('body').on("click", "#nel_carrello", function() {
         ...
         $('.cart-area').load('functionload.php',{function:'aggiorna_carrello_inalto',metodo:'aggiungi',id:id_prodotto,qty:qty});
         window.setTimeout(function () {  $("#alert-"+id_prodotto).alert('close'); }, 2000);               
    ...
    //Aggiunge prodotto a carello nella home, e poi mostra il messaggio sotto al prodotto,pagina index
     ...
     $('body').on("click", ".add_carrello", function() {
         ...
         $('.cart-area').load('functionload.php',{function:'aggiorna_carrello_inalto',metodo:'aggiungi',id:id_prodotto,qty:'1'});
         window.setTimeout(function () {  $(".alert-"+cont_prodotto).alert('close'); }, 2000);               
     ...
     $('body').on("click", ".prod_trash", function() {
         var id_prodotto=$(this).attr('for');
          $('.cart-area').load('functionload.php',{function:'aggiorna_carrello_inalto',metodo:'elimina',id:id_prodotto});
     });
     
     //Aumento quantit� prodotto di uno in modal view
     $('body').on("click", ".quantity-plus", function() {
          $('.quantity-input').val(parseInt($('.quantity-input').val())+1);
     }); 
     
     //Diminuisco quantit� prodotto di uno in modal view
