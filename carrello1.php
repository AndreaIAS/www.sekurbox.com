                                    ...
                                    <div class="billing-details-area">
                                        ...
                                        <div class="ship-to-another-area">
                                            <h2 class="cart-area-title" style="font-size:14px;"><?= $lang['sped_diverso']; ?>
                                                <span><input type="checkbox" name="sped_diverso" id="sped_diverso" onclick="if($(this).prop('checked')){$('#new_ship :input ').prop('required',true);  $('#new_ship').show();}else{$('#new_ship :input ').prop('required',false);$('#new_ship').hide();}" /></span>
                                            </h2>
                                        </div>
                                    </div>
                                </div>
