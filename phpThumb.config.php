...
$PHPTHUMB_CONFIG['document_root'] ='/web/htdocs/www.noleggionettuno.com/home/gevenit';
//$PHPTHUMB_CONFIG['document_root'] = 'c:\\webroot\\example.com\\www';
//$PHPTHUMB_CONFIG['document_root'] = '/home/meshop/domains';
...
//echo $PHPTHUMB_CONFIG['document_root'];
...
$PHPTHUMB_CONFIG['cache_directory'] = dirname(__FILE__).'/images/cache/';                            // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_source_directory'] = dirname(__FILE__).'/images/cache/source/';  // set the cache directory for unprocessed source images
...
$PHPTHUMB_CONFIG['error_image_width']           = 10;      // default width for error images
$PHPTHUMB_CONFIG['error_image_height']          = 10;      // default height for error images
$PHPTHUMB_CONFIG['error_message_image_default'] = './images/noimage.png';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
